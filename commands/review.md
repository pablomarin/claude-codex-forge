# /review — Host-neutral Fresh Review and Investigation
...
Classify `$ARGUMENTS` as one of: General second opinion/analysis/brainstorming/question (`general`),
plan, PRD, review comments, code review, investigation, or independent investigation reproduction.
