...
| File                | What it checks                                                                                                                                                                                                                                                                              |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `test-setup.sh`     | Runs `setup.sh --with-playwright` against 5 project layouts (flat, `frontend/`, multi-candidate, `--playwright-dir` override, `apps/r&d` metachar), plus idempotency (hash-based) and `--upgrade` smoke                                                                                     |
| `test-setup-flags.sh` | Focused public CLI contract for routine `--upgrade`, transactional `--force`, dry-run, preservation, and deprecated aliases                                                                                                                        |
