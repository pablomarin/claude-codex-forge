...
| Number                                                  | Title                                                                                  | Status                |
| ------------------------------------------------------- | -------------------------------------------------------------------------------------- | --------------------- |
| [0001](0001-volatile-state-not-auto-loaded.md)          | Volatile workflow state is gitignored and not auto-loaded                              | Amended by 0010      |
| [0002](0002-bash-and-powershell-dual-platform.md)       | Forge ships bash and PowerShell hooks in parallel                                      | Accepted (2026-04-28) |
| [0003](0003-template-distributed-no-build-step.md)      | Forge is distributed with no build step                                                 | Amended by 0010      |
