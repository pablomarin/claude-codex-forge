...
Detailed E2E doctrine for Forge workflows. This file is loaded on demand when designing or verifying user-facing E2E use cases; keep `rules/testing.md` as the compact always-loaded index.

Read this before writing E2E use cases in `/new-feature` Phase 3.2b, `/fix-bug` Phase 3.2b, or `/fix-bug` simple-fix Step 0.
